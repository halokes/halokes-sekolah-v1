...
class SchoolEditRequest extends FormRequest
{
    ...
    {
        // Only admin and superintendent can edit schools
    ...
    {
        $schoolId = $this->route('school'); // Assuming route parameter is 'school'

        return [
            'name' => ['required', 'string', 'max:255'],
            'code' => ['required', 'string', 'max:255', Rule::unique('schools', 'code')->ignore($schoolId)],
